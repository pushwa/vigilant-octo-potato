...
// Canvas
const canvasZoomed = document.getElementById('zoomedInCanvas');
...
function init() {
  ...
  // Fog
  scene.fog = new THREE.Fog(0x96c93d, 0.5, 5, 4000);
...
function render() {
  ...
  if (document.body.scrollTop > 10 || document.documentElement.scrollTop > 10) {
    canvasZoomed.style.opacity = 0;
  } else {
    canvasZoomed.style.opacity = 1;
  }
  ...
  if (mobile.matches) {
    ...
    // Camera position
    camera.position.set(-1.1, 1.2, 2.5);
